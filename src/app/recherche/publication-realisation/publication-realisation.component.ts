...
@Component({
  selector: 'app-publication-realisation',
  templateUrl: './publication-realisation.component.html',
  styleUrls: ['./publication-realisation.component.css']
})
export class PublicationRealisationComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.data = [
      {
        'id': '1',
        'nom': 'Publications et realisations',
